	...
	:	Module::Module(_vnx_name)
{
	...
	vnx::read_config(vnx_name + ".auto_login", auto_login);
	vnx::read_config(vnx_name + ".import_list", import_list);
	vnx::read_config(vnx_name + ".export_list", export_list);
	vnx::read_config(vnx_name + ".forward_list", forward_list);
	vnx::read_config(vnx_name + ".tunnel_list", tunnel_list);
	...
	vnx::read_config(vnx_name + ".request_tunnel", request_tunnel);
	vnx::read_config(vnx_name + ".auto_import", auto_import);
	vnx::read_config(vnx_name + ".time_sync", time_sync);
	vnx::read_config(vnx_name + ".allow_login", allow_login);
	vnx::read_config(vnx_name + ".use_authentication", use_authentication);
	vnx::read_config(vnx_name + ".block_until_connect", block_until_connect);
	vnx::read_config(vnx_name + ".block_until_reconnect", block_until_reconnect);
...
vnx::Hash64 BaseProxyBase::get_type_hash() const {
	return VNX_TYPE_HASH;
}

std::string BaseProxyBase::get_type_name() const {
	return "vnx.BaseProxy";
}

const vnx::TypeCode* BaseProxyBase::get_type_code() const {
	return vnx::vnx_native_type_code_BaseProxyBase;
}

void BaseProxyBase::accept(vnx::Visitor& _visitor) const {
	const vnx::TypeCode* _type_code = vnx::vnx_native_type_code_BaseProxyBase;
...
void BaseProxyBase::write(std::ostream& _out) const {
	_out << "{";
...
void BaseProxyBase::read(std::istream& _in) {
	if(auto _json = vnx::read_json(_in)) {
		from_object(_json->to_object());
	}
}

vnx::Object BaseProxyBase::to_object() const {
	vnx::Object _object;
	_object["__type"] = "vnx.BaseProxy";
...
void BaseProxyBase::from_object(const vnx::Object& _object) {
...
vnx::Variant BaseProxyBase::get_field(const std::string& _name) const {
	if(_name == "address") {
...
void BaseProxyBase::set_field(const std::string& _name, const vnx::Variant& _value) {
	if(_name == "address") {
		_value.to(address);
...
/// \private
std::istream& operator>>(std::istream& _in, BaseProxyBase& _value) {
	_value.read(_in);
	return _in;
}

const vnx::TypeCode* BaseProxyBase::static_get_type_code() {
...
std::shared_ptr<vnx::TypeCode> BaseProxyBase::static_create_type_code() {
	...
	type_code->methods[9] = ::vnx::ProxyInterface_login::static_get_type_code();
	type_code->methods[10] = ::vnx::ProxyInterface_enable_import::static_get_type_code();
	type_code->methods[11] = ::vnx::ProxyInterface_disable_import::static_get_type_code();
	type_code->methods[12] = ::vnx::ProxyInterface_enable_export::static_get_type_code();
	type_code->methods[13] = ::vnx::ProxyInterface_disable_export::static_get_type_code();
	type_code->methods[14] = ::vnx::ProxyInterface_enable_forward::static_get_type_code();
	type_code->methods[15] = ::vnx::ProxyInterface_disable_forward::static_get_type_code();
	type_code->methods[16] = ::vnx::ProxyInterface_enable_tunnel::static_get_type_code();
	type_code->methods[17] = ::vnx::ProxyInterface_disable_tunnel::static_get_type_code();
	type_code->methods[18] = ::vnx::ProxyInterface_wait_on_connect::static_get_type_code();
	type_code->methods[19] = ::vnx::ProxyInterface_wait_on_disconnect::static_get_type_code();
	...
	type_code->methods[23] = ::vnx::ProxyInterface_on_login::static_get_type_code();
...
void BaseProxyBase::vnx_handle_switch(std::shared_ptr<const vnx::Value> _value) {
...
std::shared_ptr<vnx::Value> BaseProxyBase::vnx_call_switch(std::shared_ptr<const vnx::Value> _method, const vnx::request_id_t& _request_id) {
...
void BaseProxyBase::login_async_return(const vnx::request_id_t& _request_id, const std::shared_ptr<const ::vnx::Session>& _ret_0) const {
	auto _return_value = ::vnx::ProxyInterface_login_return::create();
	_return_value->_ret_0 = _ret_0;
	vnx_async_return(_request_id, _return_value);
}

void BaseProxyBase::wait_on_connect_async_return(const vnx::request_id_t& _request_id, const ::vnx::Hash64& _ret_0) const {
	auto _return_value = ::vnx::ProxyInterface_wait_on_connect_return::create();
	_return_value->_ret_0 = _ret_0;
	vnx_async_return(_request_id, _return_value);
}

void BaseProxyBase::wait_on_disconnect_async_return(const vnx::request_id_t& _request_id, const ::vnx::Hash64& _ret_0) const {
	auto _return_value = ::vnx::ProxyInterface_wait_on_disconnect_return::create();
	_return_value->_ret_0 = _ret_0;
	vnx_async_return(_request_id, _return_value);
}
...
void write(TypeOutput& out, const ::vnx::BaseProxyBase& value, const TypeCode* type_code, const uint16_t* code) {
	...
	if(!type_code || (code && code[0] == CODE_ANY)) {
		type_code = vnx::vnx_native_type_code_BaseProxyBase;
		out.write_type_code(type_code);
		vnx::write_class_header<::vnx::BaseProxyBase>(out);
	}
