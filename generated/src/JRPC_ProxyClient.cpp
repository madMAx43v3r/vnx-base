...
#include <vnx/JRPC_ProxyClient.hxx>
...
JRPC_ProxyClient::JRPC_ProxyClient(const std::string& service_name)
	:	Client::Client(vnx::Hash64(service_name))
{
}

JRPC_ProxyClient::JRPC_ProxyClient(vnx::Hash64 service_addr)
...
void JRPC_ProxyClient::enable_import(const std::string& topic_name) {
	auto _method = ::vnx::ProxyInterface_enable_import::create();
	_method->topic_name = topic_name;
	vnx_request(_method, false);
}

void JRPC_ProxyClient::enable_import_async(const std::string& topic_name) {
	auto _method = ::vnx::ProxyInterface_enable_import::create();
	_method->topic_name = topic_name;
	vnx_request(_method, true);
}

void JRPC_ProxyClient::disable_import(const std::string& topic_name) {
	auto _method = ::vnx::ProxyInterface_disable_import::create();
	_method->topic_name = topic_name;
	vnx_request(_method, false);
}

void JRPC_ProxyClient::disable_import_async(const std::string& topic_name) {
	auto _method = ::vnx::ProxyInterface_disable_import::create();
	_method->topic_name = topic_name;
	vnx_request(_method, true);
}

void JRPC_ProxyClient::enable_export(const std::string& topic_name) {
	auto _method = ::vnx::ProxyInterface_enable_export::create();
	_method->topic_name = topic_name;
	vnx_request(_method, false);
}

void JRPC_ProxyClient::enable_export_async(const std::string& topic_name) {
	auto _method = ::vnx::ProxyInterface_enable_export::create();
	_method->topic_name = topic_name;
	vnx_request(_method, true);
}

void JRPC_ProxyClient::disable_export(const std::string& topic_name) {
	auto _method = ::vnx::ProxyInterface_disable_export::create();
	_method->topic_name = topic_name;
	vnx_request(_method, false);
}

void JRPC_ProxyClient::disable_export_async(const std::string& topic_name) {
	auto _method = ::vnx::ProxyInterface_disable_export::create();
	_method->topic_name = topic_name;
	vnx_request(_method, true);
}

void JRPC_ProxyClient::enable_forward(const std::string& service_name, const int32_t& max_queue_ms, const int32_t& max_queue_size) {
...
void JRPC_ProxyClient::enable_forward_async(const std::string& service_name, const int32_t& max_queue_ms, const int32_t& max_queue_size) {
	auto _method = ::vnx::ProxyInterface_enable_forward::create();
	_method->service_name = service_name;
	_method->max_queue_ms = max_queue_ms;
	_method->max_queue_size = max_queue_size;
...
void JRPC_ProxyClient::disable_forward(const std::string& service_name) {
	auto _method = ::vnx::ProxyInterface_disable_forward::create();
	_method->service_name = service_name;
	vnx_request(_method, false);
}

void JRPC_ProxyClient::disable_forward_async(const std::string& service_name) {
	auto _method = ::vnx::ProxyInterface_disable_forward::create();
	_method->service_name = service_name;
	vnx_request(_method, true);
}

void JRPC_ProxyClient::enable_tunnel(const ::vnx::Hash64& tunnel_addr, const int32_t& max_queue_ms, const int32_t& max_queue_size) {
...
void JRPC_ProxyClient::enable_tunnel_async(const ::vnx::Hash64& tunnel_addr, const int32_t& max_queue_ms, const int32_t& max_queue_size) {
	auto _method = ::vnx::ProxyInterface_enable_tunnel::create();
	_method->tunnel_addr = tunnel_addr;
	_method->max_queue_ms = max_queue_ms;
	_method->max_queue_size = max_queue_size;
...
void JRPC_ProxyClient::disable_tunnel(const ::vnx::Hash64& tunnel_addr) {
	auto _method = ::vnx::ProxyInterface_disable_tunnel::create();
	_method->tunnel_addr = tunnel_addr;
	vnx_request(_method, false);
}

void JRPC_ProxyClient::disable_tunnel_async(const ::vnx::Hash64& tunnel_addr) {
	auto _method = ::vnx::ProxyInterface_disable_tunnel::create();
	_method->tunnel_addr = tunnel_addr;
	vnx_request(_method, true);
}

std::shared_ptr<const ::vnx::Session> JRPC_ProxyClient::get_session() {
...
::vnx::Hash64 JRPC_ProxyClient::wait_on_connect() {
...
::vnx::Hash64 JRPC_ProxyClient::wait_on_disconnect() {
...
void JRPC_ProxyClient::on_connect() {
	auto _method = ::vnx::ProxyInterface_on_connect::create();
	vnx_request(_method, false);
}

void JRPC_ProxyClient::on_connect_async() {
	auto _method = ::vnx::ProxyInterface_on_connect::create();
	vnx_request(_method, true);
}

void JRPC_ProxyClient::on_disconnect() {
	auto _method = ::vnx::ProxyInterface_on_disconnect::create();
	vnx_request(_method, false);
}

void JRPC_ProxyClient::on_disconnect_async() {
	auto _method = ::vnx::ProxyInterface_on_disconnect::create();
	vnx_request(_method, true);
}

void JRPC_ProxyClient::on_remote_connect(const ::vnx::Hash64& process_id) {
	auto _method = ::vnx::ProxyInterface_on_remote_connect::create();
	_method->process_id = process_id;
	vnx_request(_method, false);
}

void JRPC_ProxyClient::on_remote_connect_async(const ::vnx::Hash64& process_id) {
	auto _method = ::vnx::ProxyInterface_on_remote_connect::create();
	_method->process_id = process_id;
	vnx_request(_method, true);
}

void JRPC_ProxyClient::on_login(const std::string& name, const std::string& password) {
...
void JRPC_ProxyClient::on_login_async(const std::string& name, const std::string& password) {
	auto _method = ::vnx::ProxyInterface_on_login::create();
	_method->name = name;
	_method->password = password;
	vnx_request(_method, true);
...
void JRPC_ProxyClient::on_remote_login(std::shared_ptr<const ::vnx::Session> remote_session) {
	auto _method = ::vnx::ProxyInterface_on_remote_login::create();
	_method->remote_session = remote_session;
	vnx_request(_method, false);
}

void JRPC_ProxyClient::on_remote_login_async(std::shared_ptr<const ::vnx::Session> remote_session) {
	auto _method = ::vnx::ProxyInterface_on_remote_login::create();
	_method->remote_session = remote_session;
	vnx_request(_method, true);
}

::vnx::Object JRPC_ProxyClient::vnx_get_config_object() {
...
::vnx::Variant JRPC_ProxyClient::vnx_get_config(const std::string& name) {
...
void JRPC_ProxyClient::vnx_set_config_object(const ::vnx::Object& config) {
	auto _method = ::vnx::ModuleInterface_vnx_set_config_object::create();
	_method->config = config;
	vnx_request(_method, false);
}

void JRPC_ProxyClient::vnx_set_config_object_async(const ::vnx::Object& config) {
	auto _method = ::vnx::ModuleInterface_vnx_set_config_object::create();
	_method->config = config;
	vnx_request(_method, true);
}

void JRPC_ProxyClient::vnx_set_config(const std::string& name, const ::vnx::Variant& value) {
...
void JRPC_ProxyClient::vnx_set_config_async(const std::string& name, const ::vnx::Variant& value) {
	auto _method = ::vnx::ModuleInterface_vnx_set_config::create();
	_method->name = name;
	_method->value = value;
	vnx_request(_method, true);
...
::vnx::TypeCode JRPC_ProxyClient::vnx_get_type_code() {
...
std::shared_ptr<const ::vnx::ModuleInfo> JRPC_ProxyClient::vnx_get_module_info() {
...
void JRPC_ProxyClient::vnx_restart() {
	auto _method = ::vnx::ModuleInterface_vnx_restart::create();
	vnx_request(_method, false);
}

void JRPC_ProxyClient::vnx_restart_async() {
	auto _method = ::vnx::ModuleInterface_vnx_restart::create();
	vnx_request(_method, true);
}

void JRPC_ProxyClient::vnx_stop() {
	auto _method = ::vnx::ModuleInterface_vnx_stop::create();
	vnx_request(_method, false);
}

void JRPC_ProxyClient::vnx_stop_async() {
	auto _method = ::vnx::ModuleInterface_vnx_stop::create();
	vnx_request(_method, true);
}

vnx::bool_t JRPC_ProxyClient::vnx_self_test() {
