...
GatewayClient::GatewayClient(const std::string& service_name)
	:	Client::Client(vnx::Hash64(service_name))
{
}

GatewayClient::GatewayClient(vnx::Hash64 service_addr)
...
::vnx::Variant GatewayClient::vnx_get_config(const std::string& name) {
...
void GatewayClient::vnx_set_config_object(const ::vnx::Object& config) {
	auto _method = ::vnx::ModuleInterface_vnx_set_config_object::create();
	_method->config = config;
	vnx_request(_method, false);
}

void GatewayClient::vnx_set_config_object_async(const ::vnx::Object& config) {
	auto _method = ::vnx::ModuleInterface_vnx_set_config_object::create();
	_method->config = config;
	vnx_request(_method, true);
}

void GatewayClient::vnx_set_config(const std::string& name, const ::vnx::Variant& value) {
...
void GatewayClient::vnx_set_config_async(const std::string& name, const ::vnx::Variant& value) {
	auto _method = ::vnx::ModuleInterface_vnx_set_config::create();
	_method->name = name;
	_method->value = value;
	vnx_request(_method, true);
...
::vnx::TypeCode GatewayClient::vnx_get_type_code() {
...
std::shared_ptr<const ::vnx::ModuleInfo> GatewayClient::vnx_get_module_info() {
...
void GatewayClient::vnx_restart() {
	auto _method = ::vnx::ModuleInterface_vnx_restart::create();
	vnx_request(_method, false);
}

void GatewayClient::vnx_restart_async() {
	auto _method = ::vnx::ModuleInterface_vnx_restart::create();
	vnx_request(_method, true);
}

void GatewayClient::vnx_stop() {
	auto _method = ::vnx::ModuleInterface_vnx_stop::create();
	vnx_request(_method, false);
}

void GatewayClient::vnx_stop_async() {
	auto _method = ::vnx::ModuleInterface_vnx_stop::create();
	vnx_request(_method, true);
}

vnx::bool_t GatewayClient::vnx_self_test() {
