...
#include <vnx/JRPC_ProxyAsyncClient.hxx>
...
JRPC_ProxyAsyncClient::JRPC_ProxyAsyncClient(const std::string& service_name)
	:	AsyncClient::AsyncClient(vnx::Hash64(service_name))
{
}

JRPC_ProxyAsyncClient::JRPC_ProxyAsyncClient(vnx::Hash64 service_addr)
...
uint64_t JRPC_ProxyAsyncClient::enable_import(const std::string& topic_name, const std::function<void()>& _callback, const std::function<void(const vnx::exception&)>& _error_callback) {
...
uint64_t JRPC_ProxyAsyncClient::disable_import(const std::string& topic_name, const std::function<void()>& _callback, const std::function<void(const vnx::exception&)>& _error_callback) {
...
uint64_t JRPC_ProxyAsyncClient::enable_export(const std::string& topic_name, const std::function<void()>& _callback, const std::function<void(const vnx::exception&)>& _error_callback) {
...
uint64_t JRPC_ProxyAsyncClient::disable_export(const std::string& topic_name, const std::function<void()>& _callback, const std::function<void(const vnx::exception&)>& _error_callback) {
...
uint64_t JRPC_ProxyAsyncClient::enable_forward(const std::string& service_name, const int32_t& max_queue_ms, const int32_t& max_queue_size, const std::function<void()>& _callback, const std::function<void(const vnx::exception&)>& _error_callback) {
...
uint64_t JRPC_ProxyAsyncClient::disable_forward(const std::string& service_name, const std::function<void()>& _callback, const std::function<void(const vnx::exception&)>& _error_callback) {
...
uint64_t JRPC_ProxyAsyncClient::enable_tunnel(const ::vnx::Hash64& tunnel_addr, const int32_t& max_queue_ms, const int32_t& max_queue_size, const std::function<void()>& _callback, const std::function<void(const vnx::exception&)>& _error_callback) {
...
uint64_t JRPC_ProxyAsyncClient::disable_tunnel(const ::vnx::Hash64& tunnel_addr, const std::function<void()>& _callback, const std::function<void(const vnx::exception&)>& _error_callback) {
...
uint64_t JRPC_ProxyAsyncClient::get_session(const std::function<void(std::shared_ptr<const ::vnx::Session>)>& _callback, const std::function<void(const vnx::exception&)>& _error_callback) {
...
uint64_t JRPC_ProxyAsyncClient::wait_on_connect(const std::function<void(const ::vnx::Hash64&)>& _callback, const std::function<void(const vnx::exception&)>& _error_callback) {
...
uint64_t JRPC_ProxyAsyncClient::wait_on_disconnect(const std::function<void(const ::vnx::Hash64&)>& _callback, const std::function<void(const vnx::exception&)>& _error_callback) {
...
uint64_t JRPC_ProxyAsyncClient::on_connect(const std::function<void()>& _callback, const std::function<void(const vnx::exception&)>& _error_callback) {
...
uint64_t JRPC_ProxyAsyncClient::on_disconnect(const std::function<void()>& _callback, const std::function<void(const vnx::exception&)>& _error_callback) {
...
uint64_t JRPC_ProxyAsyncClient::on_remote_connect(const ::vnx::Hash64& process_id, const std::function<void()>& _callback, const std::function<void(const vnx::exception&)>& _error_callback) {
...
uint64_t JRPC_ProxyAsyncClient::on_login(const std::string& name, const std::string& password, const std::function<void()>& _callback, const std::function<void(const vnx::exception&)>& _error_callback) {
...
uint64_t JRPC_ProxyAsyncClient::on_remote_login(std::shared_ptr<const ::vnx::Session> remote_session, const std::function<void()>& _callback, const std::function<void(const vnx::exception&)>& _error_callback) {
...
uint64_t JRPC_ProxyAsyncClient::vnx_get_config_object(const std::function<void(const ::vnx::Object&)>& _callback, const std::function<void(const vnx::exception&)>& _error_callback) {
...
uint64_t JRPC_ProxyAsyncClient::vnx_get_config(const std::string& name, const std::function<void(const ::vnx::Variant&)>& _callback, const std::function<void(const vnx::exception&)>& _error_callback) {
...
uint64_t JRPC_ProxyAsyncClient::vnx_set_config_object(const ::vnx::Object& config, const std::function<void()>& _callback, const std::function<void(const vnx::exception&)>& _error_callback) {
...
uint64_t JRPC_ProxyAsyncClient::vnx_set_config(const std::string& name, const ::vnx::Variant& value, const std::function<void()>& _callback, const std::function<void(const vnx::exception&)>& _error_callback) {
...
uint64_t JRPC_ProxyAsyncClient::vnx_get_type_code(const std::function<void(const ::vnx::TypeCode&)>& _callback, const std::function<void(const vnx::exception&)>& _error_callback) {
...
uint64_t JRPC_ProxyAsyncClient::vnx_get_module_info(const std::function<void(std::shared_ptr<const ::vnx::ModuleInfo>)>& _callback, const std::function<void(const vnx::exception&)>& _error_callback) {
...
uint64_t JRPC_ProxyAsyncClient::vnx_restart(const std::function<void()>& _callback, const std::function<void(const vnx::exception&)>& _error_callback) {
...
uint64_t JRPC_ProxyAsyncClient::vnx_stop(const std::function<void()>& _callback, const std::function<void(const vnx::exception&)>& _error_callback) {
...
uint64_t JRPC_ProxyAsyncClient::vnx_self_test(const std::function<void(const vnx::bool_t&)>& _callback, const std::function<void(const vnx::exception&)>& _error_callback) {
...
int32_t JRPC_ProxyAsyncClient::vnx_purge_request(uint64_t _request_id, const vnx::exception& _ex) {
...
int32_t JRPC_ProxyAsyncClient::vnx_callback_switch(uint64_t _request_id, std::shared_ptr<const vnx::Value> _value) {
	std::unique_lock<std::mutex> _lock(vnx_mutex);
	const auto _iter = vnx_pending.find(_request_id);
	if(_iter == vnx_pending.end()) {
		throw std::runtime_error("JRPC_ProxyAsyncClient: received unknown return");
	}
	const auto _index = _iter->second;
	vnx_pending.erase(_iter);
	switch(_index) {
		...
		default:
			if(_index >= 0) {
				throw std::logic_error("JRPC_ProxyAsyncClient: invalid callback index");
			}
	}
	return _index;
}
