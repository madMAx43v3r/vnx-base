...
#include <vnx/TerminalAsyncClient.hxx>
...
TerminalAsyncClient::TerminalAsyncClient(const std::string& service_name)
	:	AsyncClient::AsyncClient(vnx::Hash64(service_name))
{
}

TerminalAsyncClient::TerminalAsyncClient(vnx::Hash64 service_addr)
	:	AsyncClient::AsyncClient(service_addr)
{
}

uint64_t TerminalAsyncClient::read_char(const int8_t& c, const std::function<void()>& _callback, const std::function<void(const vnx::exception&)>& _error_callback) {
	...
	const auto _request_id = ++vnx_next_id;
	{
		...
		vnx_queue_read_char[_request_id] = std::make_pair(_callback, _error_callback);
	}
	vnx_request(_method, _request_id);
	return _request_id;
}

uint64_t TerminalAsyncClient::read_event(const ::vnx::terminal_event_e& event, const std::function<void()>& _callback, const std::function<void(const vnx::exception&)>& _error_callback) {
	...
	const auto _request_id = ++vnx_next_id;
	{
		...
		vnx_queue_read_event[_request_id] = std::make_pair(_callback, _error_callback);
	}
	vnx_request(_method, _request_id);
	return _request_id;
}

uint64_t TerminalAsyncClient::vnx_get_config_object(const std::function<void(const ::vnx::Object&)>& _callback, const std::function<void(const vnx::exception&)>& _error_callback) {
...
uint64_t TerminalAsyncClient::vnx_get_config(const std::string& name, const std::function<void(const ::vnx::Variant&)>& _callback, const std::function<void(const vnx::exception&)>& _error_callback) {
...
uint64_t TerminalAsyncClient::vnx_set_config_object(const ::vnx::Object& config, const std::function<void()>& _callback, const std::function<void(const vnx::exception&)>& _error_callback) {
...
uint64_t TerminalAsyncClient::vnx_set_config(const std::string& name, const ::vnx::Variant& value, const std::function<void()>& _callback, const std::function<void(const vnx::exception&)>& _error_callback) {
...
uint64_t TerminalAsyncClient::vnx_get_type_code(const std::function<void(const ::vnx::TypeCode&)>& _callback, const std::function<void(const vnx::exception&)>& _error_callback) {
...
uint64_t TerminalAsyncClient::vnx_get_module_info(const std::function<void(std::shared_ptr<const ::vnx::ModuleInfo>)>& _callback, const std::function<void(const vnx::exception&)>& _error_callback) {
...
uint64_t TerminalAsyncClient::vnx_restart(const std::function<void()>& _callback, const std::function<void(const vnx::exception&)>& _error_callback) {
...
uint64_t TerminalAsyncClient::vnx_stop(const std::function<void()>& _callback, const std::function<void(const vnx::exception&)>& _error_callback) {
...
uint64_t TerminalAsyncClient::vnx_self_test(const std::function<void(const vnx::bool_t&)>& _callback, const std::function<void(const vnx::exception&)>& _error_callback) {
...
int32_t TerminalAsyncClient::vnx_purge_request(uint64_t _request_id, const vnx::exception& _ex) {
	...
	switch(_index) {
		case 0: {
			const auto _iter = vnx_queue_read_char.find(_request_id);
			if(_iter != vnx_queue_read_char.end()) {
				const auto _callback = std::move(_iter->second.second);
				vnx_queue_read_char.erase(_iter);
				_lock.unlock();
				if(_callback) {
					_callback(_ex);
				}
		...
		case 1: {
			const auto _iter = vnx_queue_read_event.find(_request_id);
			if(_iter != vnx_queue_read_event.end()) {
				const auto _callback = std::move(_iter->second.second);
				vnx_queue_read_event.erase(_iter);
				_lock.unlock();
				if(_callback) {
					_callback(_ex);
				}
...
int32_t TerminalAsyncClient::vnx_callback_switch(uint64_t _request_id, std::shared_ptr<const vnx::Value> _value) {
	std::unique_lock<std::mutex> _lock(vnx_mutex);
	const auto _iter = vnx_pending.find(_request_id);
	if(_iter == vnx_pending.end()) {
		throw std::runtime_error("TerminalAsyncClient: received unknown return");
	}
	const auto _index = _iter->second;
	vnx_pending.erase(_iter);
	switch(_index) {
		case 0: {
			const auto _iter = vnx_queue_read_char.find(_request_id);
			if(_iter == vnx_queue_read_char.end()) {
				throw std::runtime_error("TerminalAsyncClient: callback not found");
			}
		...
		case 2: {
			...
			if(_callback) {
				if(auto _result = std::dynamic_pointer_cast<const ::vnx::ModuleInterface_vnx_get_config_object_return>(_value)) {
					...
					throw std::logic_error("TerminalAsyncClient: invalid return value");
				}
			}
			break;
		}
		...
		default:
			if(_index >= 0) {
				throw std::logic_error("TerminalAsyncClient: invalid callback index");
			}
	}
	return _index;
}
