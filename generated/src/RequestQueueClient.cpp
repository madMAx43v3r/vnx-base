...
#include <vnx/RequestQueueClient.hxx>
...
RequestQueueClient::RequestQueueClient(const std::string& service_name)
	:	Client::Client(vnx::Hash64(service_name))
{
}

RequestQueueClient::RequestQueueClient(vnx::Hash64 service_addr)
...
::vnx::Variant RequestQueueClient::vnx_get_config(const std::string& name) {
...
void RequestQueueClient::vnx_set_config_object(const ::vnx::Object& config) {
	auto _method = ::vnx::ModuleInterface_vnx_set_config_object::create();
	_method->config = config;
	vnx_request(_method, false);
}

void RequestQueueClient::vnx_set_config_object_async(const ::vnx::Object& config) {
	auto _method = ::vnx::ModuleInterface_vnx_set_config_object::create();
	_method->config = config;
	vnx_request(_method, true);
}

void RequestQueueClient::vnx_set_config(const std::string& name, const ::vnx::Variant& value) {
...
void RequestQueueClient::vnx_set_config_async(const std::string& name, const ::vnx::Variant& value) {
	auto _method = ::vnx::ModuleInterface_vnx_set_config::create();
	_method->name = name;
	_method->value = value;
	vnx_request(_method, true);
...
::vnx::TypeCode RequestQueueClient::vnx_get_type_code() {
...
std::shared_ptr<const ::vnx::ModuleInfo> RequestQueueClient::vnx_get_module_info() {
...
void RequestQueueClient::vnx_restart() {
	auto _method = ::vnx::ModuleInterface_vnx_restart::create();
	vnx_request(_method, false);
}

void RequestQueueClient::vnx_restart_async() {
	auto _method = ::vnx::ModuleInterface_vnx_restart::create();
	vnx_request(_method, true);
}

void RequestQueueClient::vnx_stop() {
	auto _method = ::vnx::ModuleInterface_vnx_stop::create();
	vnx_request(_method, false);
}

void RequestQueueClient::vnx_stop_async() {
	auto _method = ::vnx::ModuleInterface_vnx_stop::create();
	vnx_request(_method, true);
}

vnx::bool_t RequestQueueClient::vnx_self_test() {
