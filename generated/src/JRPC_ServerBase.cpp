...
const vnx::Hash64 JRPC_ServerBase::VNX_TYPE_HASH(0x86e4e6480e8448adull);
const vnx::Hash64 JRPC_ServerBase::VNX_CODE_HASH(0xd861685a36999c3eull);

JRPC_ServerBase::JRPC_ServerBase(const std::string& _vnx_name)
	:	BaseServer::BaseServer(_vnx_name)
{
}

vnx::Hash64 JRPC_ServerBase::get_type_hash() const {
	return VNX_TYPE_HASH;
}

std::string JRPC_ServerBase::get_type_name() const {
	return "vnx.JRPC_Server";
}

const vnx::TypeCode* JRPC_ServerBase::get_type_code() const {
	return vnx::vnx_native_type_code_JRPC_ServerBase;
}

void JRPC_ServerBase::accept(vnx::Visitor& _visitor) const {
	const vnx::TypeCode* _type_code = vnx::vnx_native_type_code_JRPC_ServerBase;
...
void JRPC_ServerBase::write(std::ostream& _out) const {
	_out << "{";
...
void JRPC_ServerBase::read(std::istream& _in) {
	if(auto _json = vnx::read_json(_in)) {
		from_object(_json->to_object());
	}
}

vnx::Object JRPC_ServerBase::to_object() const {
	vnx::Object _object;
	_object["__type"] = "vnx.JRPC_Server";
...
void JRPC_ServerBase::from_object(const vnx::Object& _object) {
...
vnx::Variant JRPC_ServerBase::get_field(const std::string& _name) const {
	if(_name == "address") {
...
void JRPC_ServerBase::set_field(const std::string& _name, const vnx::Variant& _value) {
	if(_name == "address") {
		_value.to(address);
...
/// \private
std::ostream& operator<<(std::ostream& _out, const JRPC_ServerBase& _value) {
	_value.write(_out);
	return _out;
}

/// \private
std::istream& operator>>(std::istream& _in, JRPC_ServerBase& _value) {
	_value.read(_in);
	return _in;
}

const vnx::TypeCode* JRPC_ServerBase::static_get_type_code() {
...
std::shared_ptr<vnx::TypeCode> JRPC_ServerBase::static_create_type_code() {
	auto type_code = std::make_shared<vnx::TypeCode>();
	type_code->name = "vnx.JRPC_Server";
	type_code->type_hash = vnx::Hash64(0x86e4e6480e8448adull);
	type_code->code_hash = vnx::Hash64(0xd861685a36999c3eull);
	type_code->is_native = true;
	type_code->native_size = sizeof(::vnx::JRPC_ServerBase);
...
void JRPC_ServerBase::vnx_handle_switch(std::shared_ptr<const vnx::Value> _value) {
...
std::shared_ptr<vnx::Value> JRPC_ServerBase::vnx_call_switch(std::shared_ptr<const vnx::Value> _method, const vnx::request_id_t& _request_id) {
...
void write(TypeOutput& out, const ::vnx::JRPC_ServerBase& value, const TypeCode* type_code, const uint16_t* code) {
	...
	if(!type_code || (code && code[0] == CODE_ANY)) {
		type_code = vnx::vnx_native_type_code_JRPC_ServerBase;
		out.write_type_code(type_code);
		vnx::write_class_header<::vnx::JRPC_ServerBase>(out);
	}
