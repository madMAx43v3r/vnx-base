...
SpyToolClient::SpyToolClient(const std::string& service_name)
	:	Client::Client(vnx::Hash64(service_name))
{
}

SpyToolClient::SpyToolClient(vnx::Hash64 service_addr)
	:	Client::Client(service_addr)
{
}

::vnx::Object SpyToolClient::vnx_get_config_object() {
	...
	if(auto _result = std::dynamic_pointer_cast<const ::vnx::ModuleInterface_vnx_get_config_object_return>(_return_value)) {
		...
		throw std::logic_error("SpyToolClient: invalid return value");
	}
}

::vnx::Variant SpyToolClient::vnx_get_config(const std::string& name) {
...
void SpyToolClient::vnx_set_config_object(const ::vnx::Object& config) {
	auto _method = ::vnx::ModuleInterface_vnx_set_config_object::create();
	_method->config = config;
	vnx_request(_method, false);
}

void SpyToolClient::vnx_set_config_object_async(const ::vnx::Object& config) {
	auto _method = ::vnx::ModuleInterface_vnx_set_config_object::create();
	_method->config = config;
	vnx_request(_method, true);
}

void SpyToolClient::vnx_set_config(const std::string& name, const ::vnx::Variant& value) {
...
void SpyToolClient::vnx_set_config_async(const std::string& name, const ::vnx::Variant& value) {
	auto _method = ::vnx::ModuleInterface_vnx_set_config::create();
	_method->name = name;
	_method->value = value;
	vnx_request(_method, true);
...
::vnx::TypeCode SpyToolClient::vnx_get_type_code() {
...
std::shared_ptr<const ::vnx::ModuleInfo> SpyToolClient::vnx_get_module_info() {
...
void SpyToolClient::vnx_restart() {
	auto _method = ::vnx::ModuleInterface_vnx_restart::create();
	vnx_request(_method, false);
}

void SpyToolClient::vnx_restart_async() {
	auto _method = ::vnx::ModuleInterface_vnx_restart::create();
	vnx_request(_method, true);
}

void SpyToolClient::vnx_stop() {
	auto _method = ::vnx::ModuleInterface_vnx_stop::create();
	vnx_request(_method, false);
}

void SpyToolClient::vnx_stop_async() {
	auto _method = ::vnx::ModuleInterface_vnx_stop::create();
	vnx_request(_method, true);
}

vnx::bool_t SpyToolClient::vnx_self_test() {
