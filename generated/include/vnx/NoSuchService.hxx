...
#ifndef INCLUDE_vnx_NoSuchService_HXX_
#define INCLUDE_vnx_NoSuchService_HXX_
...
public:
	...
	static constexpr uint64_t VNX_TYPE_ID = 0x2e35fc01cf168b79ull;
	...
	friend std::ostream& operator<<(std::ostream& _out, const NoSuchService& _value);
	friend std::istream& operator>>(std::istream& _in, NoSuchService& _value);
...
#endif // INCLUDE_vnx_NoSuchService_HXX_
