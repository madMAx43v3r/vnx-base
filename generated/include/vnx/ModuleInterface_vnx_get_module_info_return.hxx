...
class VNX_EXPORT ModuleInterface_vnx_get_module_info_return : public ::vnx::Value {
public:
	...
	ModuleInterface_vnx_get_module_info_return() {}
...
template<typename T>
void ModuleInterface_vnx_get_module_info_return::accept_generic(T& _visitor) const {
	_visitor.template type_begin<ModuleInterface_vnx_get_module_info_return>(1);
	_visitor.type_field("_ret_0", 0); _visitor.accept(_ret_0);
	_visitor.template type_end<ModuleInterface_vnx_get_module_info_return>(1);
}
