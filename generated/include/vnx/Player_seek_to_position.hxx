...
class VNX_EXPORT Player_seek_to_position : public ::vnx::Value {
public:
	...
	static constexpr uint64_t VNX_TYPE_ID = 0xaef7c805f3f91f23ull;
	
	Player_seek_to_position() {}
...
template<typename T>
void Player_seek_to_position::accept_generic(T& _visitor) const {
	_visitor.template type_begin<Player_seek_to_position>(1);
	_visitor.type_field("position", 0); _visitor.accept(position);
	_visitor.template type_end<Player_seek_to_position>(1);
}
