...
class VNX_EXPORT Tuple : public ::vnx::Value {
public:
...
template<typename T>
void Tuple::accept_generic(T& _visitor) const {
	_visitor.template type_begin<Tuple>(1);
	_visitor.type_field("fields", 0); _visitor.accept(fields);
	_visitor.template type_end<Tuple>(1);
}
