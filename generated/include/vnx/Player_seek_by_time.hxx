...
public:
	...
	static constexpr uint64_t VNX_TYPE_ID = 0xd00881ef749ec2b8ull;
...
template<typename T>
void Player_seek_by_time::accept_generic(T& _visitor) const {
	_visitor.template type_begin<Player_seek_by_time>(1);
	_visitor.type_field("delta_us", 0); _visitor.accept(delta_us);
	_visitor.template type_end<Player_seek_by_time>(1);
}
