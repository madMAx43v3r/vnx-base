...
#ifndef INCLUDE_vnx_BaseProxy_CLIENT_HXX_
#define INCLUDE_vnx_BaseProxy_CLIENT_HXX_
...
class BaseProxyClient : public vnx::Client {
public:
	BaseProxyClient(const std::string& service_name);
...
#endif // INCLUDE_vnx_BaseProxy_CLIENT_HXX_
