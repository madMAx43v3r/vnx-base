...
#ifndef INCLUDE_vnx_BaseProxy_ASYNC_CLIENT_HXX_
#define INCLUDE_vnx_BaseProxy_ASYNC_CLIENT_HXX_
...
class BaseProxyAsyncClient : public vnx::AsyncClient {
public:
	BaseProxyAsyncClient(const std::string& service_name);
	
	BaseProxyAsyncClient(vnx::Hash64 service_addr);
...
#endif // INCLUDE_vnx_BaseProxy_ASYNC_CLIENT_HXX_
