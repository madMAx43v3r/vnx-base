...
public:
	...
	static constexpr uint64_t VNX_TYPE_ID = 0x26b6ce86f1cebd78ull;
...
template<typename T>
void Marker::accept_generic(T& _visitor) const {
	_visitor.template type_begin<Marker>(2);
	_visitor.type_field("time", 0); _visitor.accept(time);
	_visitor.type_field("message", 1); _visitor.accept(message);
	_visitor.template type_end<Marker>(2);
}
